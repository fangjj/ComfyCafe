...
export default () => {
  return <Content>
    <div className="textBody">
      ...
      <ul className="toc">
        <li><a href="#gist">The gist</a></li>
        <li><a href="#tos">Terms of Service</a>
          <ol>
            <li><a href="#comfycafé">ComfyCafé</a></li>
            <li><a href="#visitors">Responsibility of Visitors</a></li>
            <li><a href="#other-websites">Content Posted on Other Websites</a></li>
            <li><a href="#dmca">Copyright Infringement and DMCA Policy</a></li>
            ...
            <li><a href="#warranty">General Representation and Warranty</a></li>
            <li><a href="#sanctions">US Economic Sanctions</a></li>
      ...
      <section id="gist">
        ...
        <p>
          The below Terms of Service are adapted from <a href="https://en.wordpress.com/tos/">WordPress</a>, and as such, is available under a <a href="http://creativecommons.org/licenses/by-sa/4.0/">Creative Commons Sharealike</a> license.
        </p>
      </section>
      ...
      <section id="tos">
        ...
        <section id="visitors">
          <header>
            <h4>2. Responsibility of Visitors.</h4>
          </header>
        ...
        <section id="other-websites">
          <header>
            <h4>3. Content Posted on Other Websites.</h4>
          </header>
        ...
        <section id="dmca">
          <header>
            <h4>4. Copyright Infringement and DMCA Policy.</h4>
          </header>

          <p>
            As ComfySoft LLC asks others to respect its intellectual property rights, it respects the intellectual property rights of others. If you believe that material located on or linked to by ComfyCafé violates your copyright, you are encouraged to notify ComfySoft LLC by sending an email to <a href='&#109;ailto&#58;&#100;%6D&#37;&#54;3a&#64;%&#54;3&#111;%6Df&#121;&#46;&#99;%&#54;1%66%65'>dmca&#64;comf&#121;&#46;ca&#102;e</a>. ComfySoft LLC will respond to all such notices, including as required or appropriate by removing the infringing material or disabling all links to the infringing material. ComfySoft LLC will terminate a visitor's access to and use of the Website if, under appropriate circumstances, the visitor is determined to be a repeat infringer of the copyrights or other intellectual property rights of ComfySoft LLC or others. In the case of such termination, ComfySoft LLC will have no obligation to provide a refund of any amounts previously paid to ComfySoft LLC.
          </p>
        </section>
        ...
        <section id="warranty">
          <header>
            <h4>10. General Representation and Warranty.</h4>
          </header>

          <p>
            You represent and warrant that (i) your use of our Services will be in strict accordance with the ComfySoft LLC Privacy Policy, with this Agreement, and with all applicable laws and regulations (including without limitation any local laws or regulations in your country, state, city, or other governmental area, regarding online conduct and acceptable content, and including all applicable laws regarding the transmission of technical data exported from the United States or the country in which you reside) and (ii) your use of our Services will not infringe or misappropriate the intellectual property rights of any third party.
          </p>
        </section>

        <section id="sanctions">
          <header>
            <h4>11. US Economic Sanctions.</h4>
          </header>
