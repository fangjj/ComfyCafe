  ...
  return <Content>
    <div className="textBody">
      ...
      <ul className="toc">
        ...
        <li><a href="#pii">Gathering of Personally-Identifying Information</a></li>
        <li><a href="#stats">Aggregated Statistics</a></li>
        <li><a href="#protection">Protection of Certain Personally-Identifying Information</a></li>
        <li><a href="#cookies">Cookies</a></li>
        <li><a href="#transfers">Business Transfers</a></li>
      ...
      <br />
      <p>
        <em>Your privacy is critically important to us. At ComfySoft LLC we have a few fundamental principles:</em>
      </p>
      <br />
      ...
      <p>
        ...
        This privacy policy is adapted from <a href="https://automattic.com/privacy/">Automattic's Privacy Policy</a>, and as such, is available under a <a href="http://creativecommons.org/licenses/by-sa/4.0/">Creative Commons Sharealike</a> license.
      </p>
      <p>
