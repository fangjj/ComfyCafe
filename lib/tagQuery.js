      ...
      */
      ...
      if (! _.isEmpty(rel.root)) {
        ...
        */
        ...
        /*
        And who could forget about Root->Adjective?
        Most people, probably.
        i.e. matching "black" against "black dog"
        */
        ...
        */
        ...
        /*
        Now to $or together Root->Root, Root->Child, and Root-Adjective.
        */
        queryDoc.$or = _.map(rootDoc, function (value, key) {
          var kv = {};
          kv[key] = value;
          return kv;
        });
